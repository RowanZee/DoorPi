...
The STUN protocol is available for operation behind a NAT router.''',
            ...
            configuration = [
                ...
                dict( section = SIPPHONE_SECTION, key = 'capture_device', type = 'string', default = 'ALSA: USB Headphone Set', mandatory = False, description = 'Audio device that is used for recording - if nothing is specified, then the best is used. Please search for "possible sounddevices:" in the LOG file'),
